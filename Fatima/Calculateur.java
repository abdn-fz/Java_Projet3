...
public class Calculateur {
    ...
    public static double calculerMoyenne(double[] donnees) throws ArithmeticException {
    ...
    public static void validerValeur(double valeur) throws IllegalArgumentException {      // Méthode de validation pour que toutes les notes soient positives :
        if (valeur < 0) { 
